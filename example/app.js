...
angular.module('draggableBgExample', ['chieffancypants.draggableBg'])
  .controller('ExampleCtrl', function ($scope, $rootScope, $http, $timeout) {
    $scope.images = [
      {url: 'http://c2.staticflickr.com/6/5695/20824517862_866a0bb7c1_h.jpg', posX: 20, posY: 0},
      {url: 'http://c2.staticflickr.com/6/5767/20810643016_fd4af72a49_b.jpg', posX: 0, posY: 75},
    ];
